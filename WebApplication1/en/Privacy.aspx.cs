...
namespace BRU.WEBFORMS.ASPNET.APP.en
{
    public partial class Privacy : BasePage
    {
        ...
        protected override void LoadPageContent()
        {
            ...
            cbInfoUse.ContentHtml = GetConfiguredContent("cbInfoUse", @"The information we collect is used to:
                <ul>
            ...
            cbDataSecurity.ContentHtml = GetConfiguredContent("cbDataSecurity", @"We implement appropriate security measures to protect your information:
                <ul>
            ...
            cbContact.ContentHtml = GetConfiguredContent("cbContact", @"If you have questions about this privacy policy, please contact us:
                <br /><br />
