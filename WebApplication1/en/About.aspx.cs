...
namespace BRU.WEBFORMS.ASPNET.APP.en
{
    public partial class About : BasePage
    {
        ...
        {
            cbAbout.ContentHtml = @"This project demonstrates how to create a Windows XP styled website using ASP.NET Web Forms. 
            ...
            cbHowItWorks.ContentHtml = @"The template uses a master page with frame-based layout simulation using CSS flexbox. 
            ...
            cbHistory.ContentHtml = @"This template was created to help developers build retro-styled websites that capture 
            ...
            cbContact.ContentHtml = @"If you would like to contact us for any reason, you can do so through the following channels:
                <br /><br />
                <b>Email:</b> <a href='mailto:contact@example.com'>contact@example.com</a>
                <br />
                <b>Website:</b> <a href='../Default.aspx'>Home Page</a>";

            cbLegal.ContentHtml = @"Learn more about how your data is used and the legal side of this website by visiting the 
