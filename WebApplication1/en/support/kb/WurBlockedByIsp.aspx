...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <header>
        <h1 style="font-size: 16pt; color: #000080; border-bottom: 2px solid #000080; padding-bottom: 7px; margin: 0;">
            Windows Update Restored is blocked by your ISP</h1>
        ...
        <br>
        <b>Notes</b><br>
        This fix uses one of our member's proxy servers and captures all your Internet traffic (with your client machine). 
		<u><b>It can be used for Windows Update Restored only.</b></u><br>
