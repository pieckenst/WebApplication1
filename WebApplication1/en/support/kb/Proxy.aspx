<%@ Page Title="Troubleshooting Windows Update using a Proxy" Language="C#" MasterPageFile="~/en/support/Support.master" AutoEventWireup="true" CodeBehind="Proxy.aspx.cs" Inherits="BRU.WEBFORMS.ASPNET.APP.en.support.kb.Proxy" %>
...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <header>
        <h1 style="font-size: 16pt; color: #000080; border-bottom: 2px solid #000080; padding-bottom: 7px; margin: 0;">
            Troubleshooting Windows Update using a Proxy</h1>

        <p style="font-size: 10pt; margin: 10px 0;">
            <b>Article Published: 04/15/2024</b>
        </p>
        <p><font size="2"><b>Summary</b><br>
        Troubleshooting Windows Update can easily become a pain, especially for the v2/v3.1 websites. Using a proxy tool greatly helps, 
        as it gives you what's missing in a second! This tutorial will help you setting up a proxy tool called <b>Fiddler Classic</b> 
        to troubleshoot Windows Update.<br>
        <br>
        <b>Notes</b><br>
        ...
        <main>
            <p style="font-size: 13px;">If you have any more questions or need further assistance, feel free to join our 
            <a target="_blank" href="https://discord.gg/Aqp4GgnWAg" style="color: #000080; text-decoration: none;">Discord server</a> to get help from our members.</p>
        </main>
    </header>
