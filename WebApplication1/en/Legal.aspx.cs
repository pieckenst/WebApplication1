...
namespace BRU.WEBFORMS.ASPNET.APP.en
{
    public partial class Legal : BasePage
    {
        ...
        {
            cbDisclaimer.ContentHtml = @"<font color='#660000'>
            ...
            cbLicense.ContentHtml = @"This template is provided for educational and personal use. 
                You are free to:
                <ul>
            ...
            cbTrademarks.ContentHtml = @"Windows, Windows XP, and other Microsoft product names are trademarks or 
            ...
            cbLiability.ContentHtml = @"The developers of this template shall not be held liable for any direct, 
